...
namespace PUTM
{
    namespace Bq796xx
    {
        ...
        public:
            HAL_StatusTypeDef init(std::pair<uint32_t, uint32_t> ovuv = { 3050, 4300 },
                                   std::pair<uint32_t, uint32_t> otut = { 70, 30 })
        public:
            /**
        ...
        public:
            ...
            *	@brief Poll stack status to local storage
             *  @return HAL_OK
            */
            HAL_StatusTypeDef update_status(bool (&ovuv_arr)[Config::TOTAL_CELL_COUNT], 
        ...
        public:
            ...
            *	@brief Poll stack data to local storage
             *  @return HAL_OK
            */
            HAL_StatusTypeDef update_data(float (&voltages_arr)[Config::TOTAL_CELL_COUNT], 
                                          float (&temperatures_arr)[Config::TOTAL_TEMPERATURE_COUNT]);
        public:
            /**
