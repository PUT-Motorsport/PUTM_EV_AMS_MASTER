...
namespace PUTM
{
	 ...
	 *	state and enter the idle state
        ...
        static constexpr float POLYNOMIAL_T_R[] { 7.777076e-07f, -7.102473e-05f, 2.707602e-03f, -5.571109e-02f, 6.671460e-01f, -4.667089e+00f, 1.826124e+01f, -4.023727e+01f, 3.659589e+02f };
